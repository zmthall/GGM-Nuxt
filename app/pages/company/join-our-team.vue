    ...
    <div>
      ...
      <section class="employment-page-hero-shot">
          <div class="employement-hero-shot-wrapper">
              ...
              <a href="/about-us/employment/apply?select=general" class="cta-button employement-opportunity-button">Apply Now!</a>
          </div>
      </section>
            ...
            <div class="opportunity-card-back transportation">
                ...
                <div class="department-positions">
                    ...
                    <ul class="job-opportunity-list-items">
                        <li class="job-opportunity-list-item"><span class="list-item text">Dispatcher</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="transportation|city_cab|dispatch" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Driver</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="transportation|city_cab|driver" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Admin Assist.</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="transportation|city_cab|admin_assistant" data-modal-state="closed">Job Description</button></li>
                    </ul>
                </div>
                <div class="department-positions">
                    <h3 class="opportunity-card-title">Non-Emergency</h3>
                    <ul class="job-opportunity-list-items">
                        <li class="job-opportunity-list-item"><span class="list-item text">Customer Service</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="transportation|ggmt|csr" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Driver</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="transportation|ggmt|driver" data-modal-state="closed">Job Description</button></li>
                    </ul>
                </div>
                <a href="/about-us/employment/apply?select=transportation_general" class="cta-button employment-page">Apply Now</a>
            </div>
        </div>
        <div class="employment-page-opportunity-card assisted-living">
            ...
            <div class="opportunity-card-back assisted-living">
                ...
                <div class="department-positions">
                    ...
                    <ul class="job-opportunity-list-items">
                        <li class="job-opportunity-list-item"><span class="list-item text">QMAP</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="assisted_living|qmap" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">PCP</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="assisted_living|pcp" data-modal-state="closed">Job Description</button></li>
                    </ul>
                </div>
        ...
        <div class="employment-page-opportunity-card medical-supply-store">
            ...
            <div class="opportunity-card-back medical-supply-store">
                ...
                <div class="department-positions">
                    ...
                    <ul class="job-opportunity-list-items">
                        <li class="job-opportunity-list-item"><span class="list-item text">DME Specialist</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="medical_supply|dme_specialist" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Delivery Driver</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="medical_supply|delivery_tech" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Inventory Tech.</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="medical_supply|inventory_tech" data-modal-state="closed">Job Description</button></li>
                    </ul>
                </div>
        ...
        <div class="employment-page-opportunity-card gas-station">
            ...
            <div class="opportunity-card-back gas-station">
                ...
                <div class="department-positions">
                    ...
                    <ul class="job-opportunity-list-items">
                        <li class="job-opportunity-list-item"><span class="list-item text">Manager</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="gas_station|manager" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Assistant Manager</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="gas_station|asm" data-modal-state="closed">Job Description</button></li>
                        <li class="job-opportunity-list-item"><span class="list-item text">Attendant</span><span class="list-item divider"></span><button type="button" class="list-item modal-button" data-modal-btn="gas_station|attendant" data-modal-state="closed">Job Description</button></li>
                    </ul>
                </div>
