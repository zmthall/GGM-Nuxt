  ...
  <div class="md:flex py-8 sm:px-4 gap-4 max-w-[1000px] mx-auto">
    ...
    <Transition name="fade" mode="out-in">
      <BaseLayoutPageSection :key="activeNavId" class="w-3/4">
        ...
        <div v-if="activeNavId === 'ggms'" class="max-sm:mt-4">
        ...
        <DeferRender when="visible">
          <div v-if="activeNavId === 'ggal'" class="max-sm:mt-4">
        ...
        <DeferRender when="visible">
          <div v-if="activeNavId === 'ggmc'" class="max-sm:mt-4">
