<template>
  <div :class="[{'before:w-2 before:bg-brand-primary before:rounded-lg before:absolute before:h-[110%] before:left-0 before:top-1/2 before:-translate-y-1/2 pl-3 my-4': hasLeftBorder, 'relative': hasIcon || hasLeftBorder}, padding, 'my-4']">
