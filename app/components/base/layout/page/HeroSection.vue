<template>
  <section class="relative h-[800px] max-xs:h-[950px] w-full">
    <div>
      ...
      <NuxtImg :src format="webp,avif" width="1600" height="900" densities="1" sizes="(max-width: 768px) 100vw, 800px" quality="70" class="absolute inset-0 w-full h-full object-cover z-0" :preload="{ fetchPriority: 'high' }" :alt :title loading="eager" />
    </div>
