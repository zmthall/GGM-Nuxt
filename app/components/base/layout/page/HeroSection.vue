<template>
  <section class="relative h-[800px] max-xs:h-[950px] w-full">
    <div>
      ...
      <NuxtImg :src format="webp,avif" width="1280" height="720" desnities="1" sizes="(max-width: 1024px) 100vw, 1280px" quality="40" class="absolute inset-0 w-full h-full object-cover z-0" :preload="{ fetchPriority: 'high' }" :alt :title loading="eager" />
    </div>
