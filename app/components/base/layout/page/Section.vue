...
const props = withDefaults(defineProps<{
    ...
    margin?: 'default' | 'top' | 'pTop' | 'pDefault' | undefined;
    padding?: boolean;
    class?: string;
    styling?: string;
}>(), {
...
const sectionClasses = computed(() => [
    props.margin === 'default' ? 'w-full py-12 sm:py-16' : props.margin === 'top' ? 'w-full pt-4 pb-12 sm:pt-8 sm:pb-16' : props.margin === 'pTop' ? 'w-full pt-4 sm:pt-8' : props.margin === 'pDefault' ? 'w-full pb-12 sm:pb-16' : '',
